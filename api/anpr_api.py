    ...
    for camera in cameras:
        ...
        try:
            ...
            try:
                ...
                # Declare an exchange
                channel.exchange_declare(exchange='rtspurl_for_extract_frame', exchange_type='fanout')
            except pika.exceptions.ChannelClosedByBroker:
                channel = connection.channel()
                channel.exchange_declare(exchange='rtspurl_for_extract_frame', exchange_type='fanout')
                log_info(f"Queue 'rtspurl_from_extract_frame' declared successfully.")
        except Exception as e:
        ...
        try:
            channel.basic_publish(
                exchange="rtspurl_for_extract_frame",
                routing_key="",
