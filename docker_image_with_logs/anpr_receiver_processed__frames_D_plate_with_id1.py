...
# def main(queue_name="detected_vehicle", processed_queue_name="detected_plate"):
#     """
...
url = "https://vmsapi2.ajeevi.in/api/NumberPlateDetection/Post"
...
def main(queue_name="detected_vehicle", processed_queue_name="detected_plate", rabbitmq_host="localhost"):
    """
    Main function to set up RabbitMQ connections for receiving and sending frames.
