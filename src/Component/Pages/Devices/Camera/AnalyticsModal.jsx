...
const groupOptions = {
  Vehicles: [
    ...
    "Traffic", "Traffic Light", "Without Seat belt", "Without Helmet", "Triple Riding",
    "Cattle on road",
  ],
  Person: [
    "Person", "Animals", "Bird", "Cat", "Dog", "Horse", "Sheep", "Cow",
    "Elephant", "Bear", "Zebra", "Giraffe",
  ],
  Furniture: [
    "Chair", "Couch", "Potted Plant", "Bed", "Dining Table", "Bench", "Bookshelf",
  ],
  Electronics: [
    "TV", "Laptop", "Mouse", "Remote", "Keyboard", "Cell Phone",
    "Microwave", "Oven", "Hair Drier", "Fridge",
  ],
};
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-gray-600 text-sm">
          Select the object groups you want the camera to detect. Only the group name will be displayed, 
          but all objects in the group will be sent to the analytics server.
        </p>
