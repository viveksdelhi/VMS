...
export default function MainDashboard() {
  ...
  useEffect(() => {
    axios
      .get(`${API}/api/Camera/?user_id=${userId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
                ...
                >
                  <div className="m-0 p-0">
                    <p
                      ...
                      onClick={() =>
                        handleNavigation("/alerts", { Status: "Basic" })
                      }
                  ...
                  <div className="m-0 p-0">
                    <p
                      ...
                      onClick={() =>
                        handleNavigation("/alerts", { Status: "Critical" })
                      }
                      style={{
                        cursor: "pointer",
                        padding: "8px 14px",
                  ...
                  <div className="m-0 p-0">
                    <p
                      ...
                      onClick={() =>
                        handleNavigation("/alerts", { Status: "Sevier" })
                      }
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  onClick={() =>
                    handleNavigation("/all-camera", { Status: "All" })
                  }
                >
                  View Details
                </Typography>
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  onClick={() =>
                    handleNavigation("/all-camera", { Status: "Active" })
                  }
                >
                  View Details
                </Typography>
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  onClick={() =>
                    handleNavigation("/all-camera", { Status: "Inactive" })
                  }
                  >
                  View Details
                </Typography>
            ...
            >
              <Box className="border-nome ">
                <ResponsiveContainer width="100%" height={200}>
                  <iframe
                    src="https://vmsgrafana.ajeevi.in/d-solo/fe2c25g1ki7swb/vms?from=1730205356749&to=1730205656751&timezone=browser&orgId=1&panelId=4&theme=light&__feature.dashboardSceneSolo"
                    width="450"
                    height="200"
                    frameborder="0"
                  ></iframe>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box>
                <ResponsiveContainer width="100%" height={200}>
                  <iframe
                    src="https://vmsgrafana.ajeevi.in/d-solo/fe2c25g1ki7swb/vms?from=now&to=now-5h&timezone=browser&orgId=1&panelId=2&theme=light&__feature.dashboardSceneSolo"
                    width="450"
                    height="200"
                    frameborder="0"
                  ></iframe>{" "}
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box className="border-nome ">
                <ResponsiveContainer width="100%" height={200}>
                  <iframe
                    src="https://vmsgrafana.ajeevi.in/d-solo/fe2c25g1ki7swb/vms?from=1730205356749&to=1730205656751&timezone=browser&orgId=1&panelId=3&theme=light&__feature.dashboardSceneSolo"
                    width="450"
                    height="200"
                    frameborder="0"
                  ></iframe>{" "}
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box className="border-nome ">
                <ResponsiveContainer width="100%" height={200}>
                  <iframe
                    src="https://vmsgrafana.ajeevi.in/d-solo/fe2c25g1ki7swb/vms?from=1730205356749&to=1730205656751&timezone=browser&orgId=1&panelId=1&theme=light&__feature.dashboardSceneSolo"
                    width="450"
                    height="200"
                    frameborder="0"
                  ></iframe>{" "}
