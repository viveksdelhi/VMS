...
// import smartOfficeBg from "../../../../assets/Image/ajimg/loginbg2.jpg";
...
//   minHeight: "100vh",
//   backgroundImage: `url(${smartOfficeBg})`,
...
//       // Step 3: Fetch and store credit ID
//       try {
//         const creditRes = await axios.get(`${CreditAPI}/event_credit`);
//         const latestCredit = creditRes.data.event_credits
...
//           console.log("Credit ID set:", latestCredit);
//         }
//       } catch (creditError) {
...
//         <Box mt={4} pt={3} borderTop="1px solid #eee" textAlign="center">
...
import backimg from "../../../../assets/Image/ajimg/loginbg2.jpg";
