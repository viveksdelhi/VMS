...
# API endpoint
# url  = "https://vmspyapi.ajeevi.in/api/NumberPlateReadedData/"
...
def post_data(api_url, credit_id, camera_id, event_id=3):
...
def main(queue_name="detected_plate", rabbitmq_host="rabbitmq"):
    """
