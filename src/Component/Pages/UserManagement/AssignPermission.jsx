...
import { Table, Form, Select, Button, Card, message, Tooltip, Popconfirm } from 'antd';
    ...
    <Card className="m-4">
      ...
      <div className="flex justify-between items-center bg-[#9864DB] text-white px-6 py-2 rounded-md shadow-sm mb-4">
        <div>
          ...
          <p className="text-sm text-gray-100">Assign permissions to specific roles</p>
        </div>
      </div>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">
        📋 Permissions for Role: <span className="text-purple-700">{selectedRole || 'None'}</span>
      </h3>
      <Table
