...
import FireDetails from "./fire/FireDetails";
...
const Appalert = Loadable(lazy(() => import("./analytics/Appalert")));
const TotalAlerts = Loadable(lazy(() => import("./TotalAlerts/Totalalerts")));
const AlertDashboard = Loadable(
  lazy(() => import("./alertDashboard/AlertDashboard"))
);
