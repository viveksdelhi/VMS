...
export const ObjectDetection = ({
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const selectedCamera = data.find((item) => Number(item.cameraId) === Number(cameraId));
        //  console.log(selectedCamera,"kjfhdfghj")
        if (selectedCamera) {
        ...
        setObjectData(response2.data.results[0]);
        console.log(response2.data.results[0] , "this is ");
      } catch (error) {
  ...
  const postData = {
    ...
    user_id: userId,
    credit_id: CREDIT_ID,
    running: String(selectedDetections.personDetection == 1 ?"True":"False"),
  };
  ...
  const postData3 = {
    camera_id: cameraId,
    url: publicUrl,
    running: String(selectedDetections.anpr == 1 ?"True":"False"),
    user_id: userId,
    credit_id: CREDIT_ID,
  };
