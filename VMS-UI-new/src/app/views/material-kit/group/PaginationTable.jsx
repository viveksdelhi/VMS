...
export default function PaginationTable() {
  ...
  const getApiData = () => {
    axios
      .get(
        `${API}/api/Group/Pagination?pageNumber=${pageNumber}&pageSize=${pageSize}`,
        {
          headers: {
  ...
  const sortedResults = sortData([...subscribers]);
    ...
    <Box width="100%" overflow="auto">
      ...
      <StyledTable>
        <TableHead style={{ background: "#4A628A" }}>
          <TableRow>
            ...
            {/* <TableCell className="text-light" align="left">
              Name
            </TableCell> */}
        ...
        <TableBody>
          ...
          {sortedResults.map((subscriber, index) => (
      ...
      <Dialog open={editDialogOpen} onClose={() => setEditDialogOpen(false)}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleAddOrEditCategory}>Save</Button>
        </DialogActions>
      </Dialog>
