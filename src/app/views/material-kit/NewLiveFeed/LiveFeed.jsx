...
import {
  Container, Row, Col, Dropdown, DropdownButton, Modal, Button, Spinner
} from "react-bootstrap";
import AnalyticsList from '../object/AnalyticsList';
import Hls from "hls.js";
import axios from "axios";
import {
  API, LiveFeedUrl, StreamAPI,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const updatedUrls = data.map((camera) => `${LiveFeedUrl}/${camera.id}/index.m3u8`);
        ...
        if (videoIndex < videoUrls.length) {
          ...
          cols.push(
            ...
            >
              ...
              >
                <img src={nocamera} alt="no camera" height="100%" width="100%" />
              </div>
            </Col>
          );
        }
    ...
    <Container>
      <InnerContainer className="container-fluid">
        <Dropdown onSelect={handleSelect}>
          <Dropdown.Toggle id="dropdown-basic-button" className="mt-2 mb-2 col-1 p-1" style={{ backgroundColor: 'white', color: 'black', border: "none" }}>
