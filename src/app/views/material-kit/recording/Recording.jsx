...
import { API, token, VideoAPI, StreamAPI } from "serverConnection";
...
const Recording = () => {
  ...
  const fetchRecordings = async () => {
    if (selectedCamera) {
      try {
        const response = await axios.get(
          `${StreamAPI}/list_recordings/${selectedCamera.name}`
        );
                            ...
                            <Box
                              ...
                              onClick={() =>
                                handleShowVideoModal(
                                  `${StreamAPI}/playback/${selectedCamera.name}/${recording}`
                                )
                              }
                            >
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              handleDelete(
                `${StreamAPI}/delete_recording/${selectedCamera.name}/${selectedrecording}`
              );
